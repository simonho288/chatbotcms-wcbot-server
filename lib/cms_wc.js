...
function onGetStarted(e, t, n) {
    ...
    WOOCOMMERCE.wcGetTagBySlug(i, "hot"))).then(e => (o = e, (s = new SHOPCART.ShoppingCart(t, n)).loadFromDatabase())).then(() => FBWEBHOOK.getMessengerProfile(r)).then(e => {
        ...
        let l = i.getWooCommerce().site_name;
        l = null != l ? l : "WooCommerce chatbot";
        let c = util.format("Hello %s, Welcome to %s. Please select your action", a.first_name, l);
        FBWEBHOOK.sendButtonMessage(r, t, n, c, e);
    ...
    return new Promise((e, t) => {
        a.loadFromDatabase().then(() => {
            ...
            if (t.length && t.length > 0) {
                ...
                } ], o = util.format(MSG_BROWSE_CART, t.length, t.length > 1 ? "s" : "");
                return e(FBWEBHOOK.makeButtonsMessageTemplate(n, r, o, a));
            }
